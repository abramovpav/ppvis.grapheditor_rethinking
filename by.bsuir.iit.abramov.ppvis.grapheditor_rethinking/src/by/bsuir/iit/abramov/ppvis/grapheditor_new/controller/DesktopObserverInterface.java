...
public interface DesktopObserverInterface {
	...
	public void deleteVertex(VertexComponentInterface vertex);

	public void lightDeleteEdge(EdgeComponentInterface edge);

	public void newEdge(EdgeComponentInterface edge);
	...
	public void update(List<VertexComponentInterface> vertices,
			List<EdgeComponentInterface> edges);

	public void update(List<VertexComponentInterface> vertices,
			List<VertexComponentInterface> selectedVertices,
			List<EdgeComponentInterface> edges, List<EdgeComponentInterface> selectedEdges);
